...
test("график ценностей аудитории и вопрос 8 не подменяют друг друга", () => {
  // График DNA описывает состав набора, а вопрос 8 — то, что аудитория увидела
  // в материале. Это две разные величины, поэтому обе должны остаться в отчёте.
