...
/**
 * Раздел «Корпус» (этап Е): датасеты, записи, правка.
 *
 * ─── Зачем раздел ──────────────────────────────────────────────────────────
 * Корпус — 165 сессий реальных респондентов — определяет всю выдачу продукта:
      ...
      <div className="p-8">
        {datasets.length === 0 ? (
          <div className="max-w-2xl space-y-3 text-sm text-slate">
            <p>
              Корпус в базе пуст. Пока он пуст, персоны собираются по файлу из
