 ...
 * делают, см. lib/rerun.ts. Прежние ответы (`my_previous_answers`) сюда не
 * поднимаются: их должен читать воркер из родительского отчёта в режиме
 * «Допрос», чтобы браузер не стал источником доверия для платного контекста.
 *
