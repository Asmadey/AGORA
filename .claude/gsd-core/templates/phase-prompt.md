...
<!-- For checkpoint task examples and patterns, see @/Users/asmadey/AntiGravity/AGORA/.claude/gsd-core/references/checkpoints.md -->
...
See `/Users/asmadey/AntiGravity/AGORA/.claude/gsd-core/references/tdd.md` for TDD plan structure.
...
See `/Users/asmadey/AntiGravity/AGORA/.claude/gsd-core/templates/user-setup.md` for full schema and examples
...
See `/Users/asmadey/AntiGravity/AGORA/.claude/gsd-core/workflows/verify-phase.md` for verification logic.
