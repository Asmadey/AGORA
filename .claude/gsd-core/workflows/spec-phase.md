...
ones). Reference: @/Users/asmadey/AntiGravity/AGORA/.claude/gsd-core/references/edge-probe.md.
...
# — NOT the consuming project's git root — falling back to git toplevel / /Users/asmadey/AntiGravity/AGORA/.claude.
...
EDGE_PROBE_JS=$(for _c in \
  ...
  "/Users/asmadey/AntiGravity/AGORA/.claude/gsd-core/bin/lib/edge-probe.cjs" \
  "/Users/asmadey/AntiGravity/AGORA/.claude/bin/lib/edge-probe.cjs"; do
  [ -f "$_c" ] && { echo "$_c"; break; }
done)
...
requirement list). Reference: @/Users/asmadey/AntiGravity/AGORA/.claude/gsd-core/references/prohibition-probe.md — the
...
Use the SPEC.md template from @/Users/asmadey/AntiGravity/AGORA/.claude/gsd-core/templates/spec.md.
