...
@/Users/asmadey/AntiGravity/AGORA/.claude/gsd-core/references/agent-contracts.md
@/Users/asmadey/AntiGravity/AGORA/.claude/gsd-core/references/context-budget.md
@/Users/asmadey/AntiGravity/AGORA/.claude/gsd-core/references/gates.md
</required_reading>
...
@/Users/asmadey/AntiGravity/AGORA/.claude/gsd-core/references/execute-phase-response-language.md
...
- Executor agents omit extended deviation rule examples and checkpoint examples from inline prompt — load on-demand via @/Users/asmadey/AntiGravity/AGORA/.claude/gsd-core/references/executor-examples.md
- Planner agents omit extended anti-pattern lists and specificity examples from inline prompt — load on-demand via @/Users/asmadey/AntiGravity/AGORA/.claude/gsd-core/references/planner-antipatterns.md
...
```
Pure doc-only / config-only / test-only tasks return `is_behavior_adding=false` and are exempt. When the gate trips, Read `/Users/asmadey/AntiGravity/AGORA/.claude/gsd-core/references/execute-mvp-tdd.md` for the exact halt report format.
</step>
...
2. For each plan (sequentially, ignoring wave grouping):
   ...
   c. **If "Execute":** Read and follow `/Users/asmadey/AntiGravity/AGORA/.claude/gsd-core/workflows/execute-plan.md` **inline**
...
@/Users/asmadey/AntiGravity/AGORA/.claude/gsd-core/references/execute-phase-wave-guard.md

@/Users/asmadey/AntiGravity/AGORA/.claude/gsd-core/references/execute-phase-context-guard.md
   ...
   **Sequential dispatch for parallel execution (waves with 2+ agents):**
   ...
   Agent(
     ...
     prompt="
       ...
       @/Users/asmadey/AntiGravity/AGORA/.claude/gsd-core/references/checkpoints.md
       @/Users/asmadey/AntiGravity/AGORA/.claude/gsd-core/references/tdd.md
       @/Users/asmadey/AntiGravity/AGORA/.claude/gsd-core/references/worktree-path-safety.md
       ${CONTEXT_WINDOW < 200000 ? '' : '@/Users/asmadey/AntiGravity/AGORA/.claude/gsd-core/references/executor-examples.md'}
       </execution_context>
...
@/Users/asmadey/AntiGravity/AGORA/.claude/gsd-core/references/execute-phase-quota-recovery.md

@/Users/asmadey/AntiGravity/AGORA/.claude/gsd-core/references/execute-phase-between-wave-reset.md
...
**If gaps_found:**
@/Users/asmadey/AntiGravity/AGORA/.claude/gsd-core/references/execute-phase-requirement-revert.md
```
...
Read and follow `/Users/asmadey/AntiGravity/AGORA/.claude/gsd-core/workflows/transition.md`, passing through the `--auto` flag so it propagates to the next phase invocation.
