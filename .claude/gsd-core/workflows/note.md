...
- **Global scope**: `/Users/asmadey/AntiGravity/AGORA/.claude/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/Users/asmadey/AntiGravity/AGORA/.claude/notes/`)
...
2. Glob `/Users/asmadey/AntiGravity/AGORA/.claude/notes/*.md` (if directory exists) — global notes
...
Global (/Users/asmadey/AntiGravity/AGORA/.claude/notes/):
...
2. **No `.planning/`**: Falls back to global `/Users/asmadey/AntiGravity/AGORA/.claude/notes/` — works in any directory
