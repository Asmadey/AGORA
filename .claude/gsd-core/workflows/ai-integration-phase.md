...
<required_reading>
@/Users/asmadey/AntiGravity/AGORA/.claude/gsd-core/references/ai-frameworks.md
@/Users/asmadey/AntiGravity/AGORA/.claude/gsd-core/references/ai-evals.md
</required_reading>
...
```markdown
Read /Users/asmadey/AntiGravity/AGORA/.claude/agents/gsd-framework-selector.md for instructions.
...
Copy template:
```bash
cp "/Users/asmadey/AntiGravity/AGORA/.claude/gsd-core/templates/AI-SPEC.md" "${PHASE_DIR}/${PADDED_PHASE}-AI-SPEC.md"
```
...
```markdown
Read /Users/asmadey/AntiGravity/AGORA/.claude/agents/gsd-ai-researcher.md for instructions.
...
```markdown
Read /Users/asmadey/AntiGravity/AGORA/.claude/agents/gsd-domain-researcher.md for instructions.
...
```markdown
Read /Users/asmadey/AntiGravity/AGORA/.claude/agents/gsd-eval-planner.md for instructions.
