...
INSTALL_JS_GLOBAL="/Users/asmadey/AntiGravity/AGORA/.claude/gsd-core/bin/install.js"
...
error: source skills root not found: <path>
       ...
       Run: node /Users/asmadey/AntiGravity/AGORA/.claude/gsd-core/bin/install.js --global --<runtime>
```
Then exit.
