...
<reference>
@/Users/asmadey/AntiGravity/AGORA/.claude/gsd-core/references/user-profiling.md
...
Read the user-profiling reference document at `/Users/asmadey/AntiGravity/AGORA/.claude/gsd-core/references/user-profiling.md` to load:
