...
#: полноценным.
#:
#: Записано дробью, а не как 0.67. Округление было ошибкой, и ошибкой ровно в
#: том случае, который названо в тексте выше: 8/12 = 0.6667 < 0.67, то есть
#: константа отвергала те самые восемь ответов, ради которых её и выбирали.
#: Прогон, уложившийся в порог по смыслу, краснел по арифметике округления — а
#: объяснение «QA забраковал слишком много» звучало правдоподобно и уводило
#: искать причину не там.
MIN_SURVIVING_SHARE = 2 / 3
